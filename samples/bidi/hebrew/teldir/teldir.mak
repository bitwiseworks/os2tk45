#===================================================================
#
#   TELDIR.MAK - Bidirectional Telephone Directory Sample Make file
...
$(EXEDIR)\teldirh.hlp: $(ALL_IPF)
    ipfc $(@B).ipf $@ /W3  /COUNTRY=972 /CODEPAGE=862
